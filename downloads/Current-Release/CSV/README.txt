...
If you prefer one table/file that includes all species, you can download the `all_species.csv`.
...
which contains the data tables for all 14 species in CSV.
Note that this does not include the `all_species.csv` file.