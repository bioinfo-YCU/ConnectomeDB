---
title: "{{< fa database >}} ConnectomeDB2025: <span class='highlight'>Pathway Annotations for LR Pairs</span>"
execute:
  echo: false
...
[**Diseases**](disease.qmd){.btn .btn-outline-primary .btn role="button" data-toggle="tooltip" title="Click for Relevant Diseases" } 
[**Pathways**](){.btn .btn-outline-primary .btn .active role="button" aria-disabled="true" data-toggle="tooltip" title="Currently selected"}
:::
...
from createFunctionalAnnotTable import gene_pair_pathway
