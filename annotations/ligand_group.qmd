---
title: "{{< fa database >}} ConnectomeDB2025: <span class='highlight'>Ligand Lineage Annotations for LR Pairs</span>"
execute:
  echo: false
...
[**Ligand groups**](){.btn .btn-outline-primary .btn .active role="button" aria-disabled="true" data-toggle="tooltip" title="Currently selected"}
[**Receptor groups**](receptor_group.qmd){.btn .btn-outline-primary .btn role="button" data-toggle="tooltip" title="Click for Relevant Pathways" } 
...
from createFunctionalAnnotTable import gene_pair_annot_ligand
...
def update_table():
    show(
        ...
        searchPanes={"layout": "rows-1", 
                     ...
                     "smart": True, 
                     "threshold": 1500,  # Try increasing threshold
                     "initCollapsed": True, 
                     "controls": True},
        ...
        columnDefs=[
            ...
            {"width": "425px", "targets": [1]},
            {"width": "475px", "targets": [3]},
        ],
