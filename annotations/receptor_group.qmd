---
title: "{{< fa database >}} ConnectomeDB2025: <span class='highlight'>Receptor Lineage Annotations for LR Pairs</span>"
execute:
  echo: false
...
[**Ligand groups**](ligand_group.qmd){.btn .btn-outline-primary .btn role="button" data-toggle="tooltip" title="Click for Relevant Pathways" } 
[**Receptor groups**](){.btn .btn-outline-primary .btn .active role="button" aria-disabled="true" data-toggle="tooltip" title="Currently selected"}
...
from createFunctionalAnnotTable import gene_pair_annot_receptor
...
def update_table():
    show(
        ...
        columnDefs=[
            ...
            {"width": "475px", "targets": [5]},
            {"width": "425px", "targets": [6]},
        ],
