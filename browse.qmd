...
**Path:** `{dir_info['path']}`
**Total Files:** {dir_info['total_files']} (direct files in this directory)
...
""")
    ...
    if dir_info['subdirs']:
        ...
        for subdir in dir_info['subdirs']:
            ...
            print(f"| {subdir_link} | {file_count_text} | Subdirectory |")
        print("\n---\n")
...
**Summary:** {dir_info['total_files']} direct files, {len(dir_info['subdirs'])} subdirectories containing {total_subdir_files} additional files.
""")
```