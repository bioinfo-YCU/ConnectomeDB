...
$.getJSON("../JSON/human_gene_pair.json", function(data) {
  ...
  },
  {
    ...
    "title": "<span title=\"Double-click header of Ligand ENSEMBL ID to reverse sort\">Ligand ENSEMBL ID&nbsp;</span>"
  },
  {
    "data": "Receptor ENSEMBL ID",
    "title": "<span title=\"Double-click header of Receptor ENSEMBL ID to reverse sort\">Receptor ENSEMBL ID&nbsp;</span>"
  }
];
