...
$.getJSON("../JSON/human_gene_pair.json", function(data) {
  ...
  {
    "data": "LR Pair Card",
    "title": "<span title=\"Double-click header of LR Pair Card to ensure all values are shown\">LR Pair Card&nbsp;</span>"
  },
  {
    "data": "Human LR Pair",
  ...
  {
    "data": "Human evidence",
    "title": "<span title=\"Double-click header of Human evidence to ensure all values are shown\">Human evidence&nbsp;</span>"
  }
];
        ...
        initComplete: function () {
            ...
            api.on('order.dt search.dt', function () {
                ...
                if (searchVal && searchVal.trim() !== '') {
                    ...
                    api.order([[1, 'asc']]); // fallback to column 1 ascending
                }
            });
