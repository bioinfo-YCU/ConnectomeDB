                        ...
                        if (val === '') {
                            ...
                            if (searchTerms.length > 0) {
                                ...
                                $.fn.dataTable.ext.search.push(function(settings, data, dataIndex) {
                                    ...
                                    // So, original column 6 is at data[5] and original column 7 is at data[7].

                                    var col5Value = data[5] ? data[5].toString().replace(/<[^>]*>/g, '').toLowerCase() : ''; // Original column 6

                                    var col6Value = data[7] ? data[7].toString().replace(/<[^>]*>/g, '').toLowerCase() : ''; // Original column 7

                                    console.log("Searching for:", searchTerms);

                                    console.log("Column 6 value:", col5Value);

                                    console.log("Column 7 value:", col6Value); // <<< ADD THIS LINE
