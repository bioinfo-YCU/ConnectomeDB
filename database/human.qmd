...
table.dataTable.compact>tbody>tr.selected>td.select-checkbox:after, table.dataTable.compact>tbody>tr.selected>th.select-checkbox:after{
    margin-top: -0.325rem; /* Adjusted from -0.425rem to account for the 2px added to ::before */
    margin-left: -0.05rem;
}
  ...
  { 
    ...
    initComplete: function () {
      ...
      setTimeout(function() {
        ...
        // Get unique values from both columns 5 and 6 (with checkbox)
        ...
        // Collect values from column 6 (index 6 with checkbox)
