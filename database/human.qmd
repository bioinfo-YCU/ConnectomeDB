                ...
                exportOptions: {
                    ...
                    format: {
                        ...
                        body: function(data, row, column, node) {
                            ...
                            // Get the actual column index in the full table (including hidden columns)
                            var actualColumnIndex = table.column(column + ':visible').index();

                            // Check if this is the URL column (original column 10, DataTables index 11)

                            if (actualColumnIndex === 11) {
