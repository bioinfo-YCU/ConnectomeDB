...
$.getJSON("../JSON/human_gene_pair.json", function(data) {
  ...
  {
    "data": "Human LR Pair",
    "title": "<span title=\"Ligand-receptor Pair\">Human LR Pair</span>"
  },
  {
    "data": "Ligand",
  ...
  {
    "data": "Human evidence",
    "title": "<span title=\"Direct: experimentally verified; Conservation: inferred from orthology\">Human evidence</span>"
  },
  {
                        ...
                        if (val === '') {
                            ...
                            if (searchTerms.length > 0) {
                                ...
                                $.fn.dataTable.ext.search.push(function(settings, data, dataIndex) {
                                    ...
                                    var col5Value = data[5] ? data[5].toString().replace(/<[^>]*>/g, '').toLowerCase() : ''; // Original column 6

                                    var col6Value = data[6] ? data[6].toString().replace(/<[^>]*>/g, '').toLowerCase() : ''; // Original column 7
    ...
    if (searchVal && searchVal.trim() !== '') {
        ...
        if (isCustomSearchActive) {
            api.rows().sort(function (rowIdxA, rowIdxB) {
                ...
                const valuesA = [normalize(rowDataA[5]), normalize(rowDataA[6])];
                const valuesB = [normalize(rowDataB[5]), normalize(rowDataB[6])];
