...
header-includes: |
  ...
  <script>
      document.addEventListener("DOMContentLoaded", function () {
        const columnNames = [
          "Interaction ID", "Human LR Pair", "Database Source", "Ligand", "Receptor",
          "Perplexity", "PMID", "Binding Location", "Bind in Trans?", "Bidirectional Signalling",
          "Interaction Type", "Ligand HGNC ID", "Receptor HGNC ID", "Ligand Location", "Receptor Location",
          "KEGG Pathway", "Cancer-related", "Disease Type", "Ligand Aliases", "Receptor Aliases"
        ];
...
def update_table():
    show(
        ...
        columnDefs=[
            ...
            # {"visible": False, "targets": list(range(-1, -3, -1))} # Hide last 14 columns by default
        ],
