...
<table id="macaque-table" class="display nowrap cell-border compact" style="width:100%">
    <thead></thead>
    <tfoot></tfoot>
</table>
...
$(document).ready(function() {
    ...
    $.getJSON("../../JSON/macaque_gene_pair.json", function(data) {
  ...
  {
    "data": "Macaque LR Pair",
    "title": "<span title=\"Ligand-receptor Pair\">Macaque LR Pair</span>"
  },
  {
    "data": "Ligand Symbols",
  ...
  {
    "data": "Macaque evidence",
    "title": "Macaque evidence"
  },
  {
  ...
  },
  {
    ...
    "title": "Human Receptor Symbols"
        ...
        headerHtml += '</tr>';
        $('#macaque-table thead').html(headerHtml);
        ...
        var table = $('#macaque-table').DataTable({
            data: data,
            columns: [
                {
                    data: null,
        ...
        action: function(e, dt, node, config) {
            ...
            setTimeout(function() {
                ...
                {
                    extend: 'csvHtml5',
                    filename: 'ConnectomeDB2025_macaque',
                    exportOptions: {
            ...
            updateSelectionCounter(); // ADD THIS LINE
                ...
                setTimeout(function() {
                    ...
                    $('#macaque-table').closest('.dataTables_wrapper').prepend(filterContainer);

                    var filterDiv = $('<div style="max-width: 100%;"></div>');
                    var label = $('<label></label>');

                    // Create input without datalist (no autofill)
                    var input = $('<input type="text" placeholder="Search Ligand(s) / Receptor(s): i.e. ACE, CD24, EGFR, EPHA3, CADM1" />')
                        .css({
                            'width': '100%',
                            'padding': '8px',
                            'font-size': '1.1rem',
...
api.on('order.dt search.dt', function () {
    ...
    if (searchVal && searchVal.trim() !== '') {
        ...
        console.error("JSON path:", "../../JSON/macaque_gene_pair.json");
