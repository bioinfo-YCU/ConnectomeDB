...
<div id="table-content-chimp" style="opacity: 0;">
...
<table id="chicken-table" class="display nowrap cell-border compact" style="width:100%">
    <thead></thead>
    <tfoot></tfoot>
</table>
...
$(document).ready(function() {
    ...
    $.getJSON("../../JSON/chicken_gene_pair.json", function(data) {
  ...
  {
    "data": "Chicken LR Pair",
    "title": "<span title=\"Ligand-receptor Pair\">Chicken LR Pair</span>"
  },
  {
    "data": "Ligand Symbols",
  ...
  {
    "data": "Chicken evidence",
    "title": "Chicken evidence"
  },
  {
  ...
  },
  {
    ...
    "title": "Human Receptor Symbols"
        ...
        headerHtml += '</tr>';
        $('#chicken-table thead').html(headerHtml);
        ...
        var table = $('#chicken-table').DataTable({
            data: data,
            columns: [
                {
                    data: null,
        ...
        action: function(e, dt, node, config) {
            ...
            setTimeout(function() {
                ...
                {
                    extend: 'csvHtml5',
                    filename: 'ConnectomeDB2025_chicken',
                    exportOptions: {
            ...
            updateSelectionCounter(); // ADD THIS LINE
                ...
                setTimeout(function() {
                    ...
                    $('#chicken-table').closest('.dataTables_wrapper').prepend(filterContainer);

                    var filterDiv = $('<div style="max-width: 100%;"></div>');
                    var label = $('<label></label>');

                    // Create input without datalist (no autofill)
                    var input = $('<input type="text" placeholder="Search Ligand(s) / Receptor(s): i.e. ACE, CD24, EGFR, BDKRB2, LOC395551" />')
                        .css({
                            'width': '100%',
                            'padding': '8px',
                            'font-size': '1.1rem',
...
api.on('order.dt search.dt', function () {
    ...
    if (searchVal && searchVal.trim() !== '') {
        ...
        console.error("JSON path:", "../../JSON/chicken_gene_pair.json");
