...
<div id="table-content-frog" style="opacity: 0;">
...
<table id="frog-table" class="display nowrap cell-border compact" style="width:100%">
    <thead></thead>
    <tfoot></tfoot>
</table>
...
$(document).ready(function() {
    ...
    $.getJSON("../../JSON/frog_gene_pair.json", function(data) {
  ...
  {
    "data": "Frog LR Pair",
    "title": "<span title=\"Ligand-receptor Pair\">Frog LR Pair</span>"
  },
  {
    "data": "Ligand Symbols",
  ...
  {
    "data": "Ligand XEN ID",
    "title": "<span title=\"Xenbase ID (link to XEN). Click on the link for more details\">Ligand XEN ID</span>"
  },
  {
    "data": "Receptor XEN ID",
    "title": "<span title=\"Xenbase ID (link to XEN). Click on the link for more details\">Receptor XEN ID</span>"
  },
  {
    "data": "Perplexity",
  ...
  },
  {
    ...
    "title": "<span title=\"ENSEMBL gene ID for the receptor (link to ENSEMBL)\">Receptor ENSEMBL ID</span>"
        ...
        headerHtml += '</tr>';
        $('#frog-table thead').html(headerHtml);
        ...
        var table = $('#frog-table').DataTable({
            data: data,
            columns: [
                {
                    data: null,
        ...
        action: function(e, dt, node, config) {
            ...
            setTimeout(function() {
                ...
                {
                    extend: 'csvHtml5',
                    filename: 'ConnectomeDB2025_frog',
                    exportOptions: {
            ...
            updateSelectionCounter(); // ADD THIS LINE
                ...
                setTimeout(function() {
                    ...
                    $('#frog-table').closest('.dataTables_wrapper').prepend(filterContainer);

                    var filterDiv = $('<div style="max-width: 100%;"></div>');
                    var label = $('<label></label>');

                    // Create input without datalist (no autofill)
                    var input = $('<input type="text" placeholder="Search Ligand(s) / Receptor(s): i.e. ACE, CD24, EGFR, ccl5, rantes" />')
                        .css({
                            'width': '100%',
                            'padding': '8px',
                            'font-size': '1.1rem',
...
api.on('order.dt search.dt', function () {
    ...
    if (searchVal && searchVal.trim() !== '') {
        ...
        console.error("JSON path:", "../../JSON/frog_gene_pair.json");
