---
title: "Zebrafish \u2013 *Danio rerio* (2025-09-26) </span>"
execute:
  echo: false
format:
  html:
...
<div id="loading-widget-page13" class="loading-container">
...
<div id="table-content13" style="opacity: 0;">
...
<script>
(function() {
    function hideLoadingShowTablePage13() {
        document.getElementById('loading-widget-page13').style.display = 'none';
        document.getElementById('table-content13').style.opacity = '1';
    }
    
    // Make it globally available
    window.hideLoadingShowTablePage13 = hideLoadingShowTablePage13;
    
    // Fallback timeout
    setTimeout(function() {
        hideLoadingShowTablePage13();
    }, 2000);
})();
</script>
