...
def update_table():
    show(
        ...
        buttons=[
            ...
            {"extend": "csvHtml5", "filename": "ConnectomeDB2025_zebrafish"},
            {"extend": "excelHtml5", "filename": "ConnectomeDB2025_zebrafish"},
            {"extend": "copyHtml5", "filename": "ConnectomeDB2025_zebrafish", "title": None},
        ],
        columnDefs=[
            {"className": "dt-center", "targets": [-6]}, 
            # {"width": "100px", "targets": "_all"},
            {"width": "275px", "targets": [23,24]},
            {"targets": list(range(-1, -6, -1))+ [3,4,21,22], "visible": False} # Hide last n columns by default
        ],
