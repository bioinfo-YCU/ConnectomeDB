...
$(document).ready(function() {
  ...
  {
    "data": "Chimp LR Pair",
    "title": "<span title=\"Ligand-receptor Pair\">Chimp LR Pair</span>"
  },
  {
    "data": "Ligand Symbols",
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    setTimeout(function() {
        if (document.getElementById('table-content-chimp').style.opacity == '0') {
            document.getElementById('loading-widget').style.display = 'none';
            document.getElementById('table-content-chimp').style.opacity = '1';
        }
    }, 15000);
});
