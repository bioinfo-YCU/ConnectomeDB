...
<div id="table-content-rat" style="opacity: 0;">
...
$(document).ready(function() {
  ...
  {
    "data": "Rat LR Pair",
    "title": "<span title=\"Ligand-receptor Pair\">Rat LR Pair</span>"
  },
  {
    "data": "Ligand Symbols",
  ...
  {
    "data": "Ligand RGD ID",
    "title": "<span title=\"Rat Genome Database ID (link to RGD). Click on the link for more details\">Ligand RGD ID</span>"
  },
  {
    "data": "Receptor RGD ID",
    "title": "<span title=\"Rat Genome Database ID (link to RGD). Click on the link for more details\">Receptor RGD ID</span>"
  },
  {
    "data": "Perplexity",
        ...
        action: function(e, dt, node, config) {
            ...
            updateSelectionCounter(); // ADD THIS LINE
                ...
                setTimeout(function() {
                    ...
                    var input = $('<input type="text" placeholder="Search Ligand(s) / Receptor(s): i.e. ACE, CD24, EGFR, Cck, Vav1" />')
                        .css({
                            'width': '100%',
                            'padding': '8px',
                            'font-size': '1.1rem',
