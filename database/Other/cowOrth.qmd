...
<div id="table-content-cow" style="opacity: 0;">
...
<table id="cow-table" class="display nowrap cell-border compact" style="width:100%">
    <thead></thead>
    <tfoot></tfoot>
</table>
...
$(document).ready(function() {
    ...
    $.getJSON("../../JSON/cow_gene_pair.json", function(data) {
  ...
  {
    "data": "Cow LR Pair",
    "title": "<span title=\"Ligand-receptor Pair\">Cow LR Pair</span>"
  },
  {
    "data": "Ligand Symbols",
  ...
  },
  {
    ...
    "title": "Human Receptor Symbols"
        ...
        headerHtml += '</tr>';
        $('#cow-table thead').html(headerHtml);
        ...
        action: function(e, dt, node, config) {
            ...
            updateSelectionCounter(); // ADD THIS LINE
                ...
                setTimeout(function() {
                    ...
                    $('#cow-table').closest('.dataTables_wrapper').prepend(filterContainer);

                    var filterDiv = $('<div style="max-width: 100%;"></div>');
                    var label = $('<label></label>');

                    // Create input without datalist (no autofill)
                    var input = $('<input type="text" placeholder="Search Ligand(s) / Receptor(s): i.e. ACE, CD24, EGFR, LOC508666, CCR10" />')
                        .css({
                            'width': '100%',
                            'padding': '8px',
                            'font-size': '1.1rem',
...
api.on('order.dt search.dt', function () {
    ...
    if (searchVal && searchVal.trim() !== '') {
        ...
        console.error("JSON path:", "../../JSON/cow_gene_pair.json");
