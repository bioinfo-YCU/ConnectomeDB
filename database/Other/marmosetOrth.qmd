...
<div id="table-content-marmoset" style="opacity: 0;">
...
<table id="marmoset-table" class="display nowrap cell-border compact" style="width:100%">
    <thead></thead>
    <tfoot></tfoot>
</table>
...
$(document).ready(function() {
    ...
    $.getJSON("../../JSON/marmoset_gene_pair.json", function(data) {
  ...
  {
    "data": "Marmoset LR Pair",
    "title": "<span title=\"Ligand-receptor Pair\">Marmoset LR Pair</span>"
  },
  {
    "data": "Ligand Symbols",
  ...
  {
    "data": "Marmoset evidence",
    "title": "Marmoset evidence"
  },
  {
  ...
  },
  {
    ...
    "title": "Human Receptor Symbols"
        ...
        headerHtml += '</tr>';
        $('#marmoset-table thead').html(headerHtml);
        ...
        var table = $('#marmoset-table').DataTable({
            data: data,
            columns: [
                {
                    data: null,
        ...
        action: function(e, dt, node, config) {
            ...
            setTimeout(function() {
                ...
                {
                    extend: 'csvHtml5',
                    filename: 'ConnectomeDB2025_marmoset',
                    exportOptions: {
            ...
            updateSelectionCounter(); // ADD THIS LINE
                ...
                setTimeout(function() {
                    ...
                    $('#marmoset-table').closest('.dataTables_wrapper').prepend(filterContainer);
...
api.on('order.dt search.dt', function () {
    ...
    if (searchVal && searchVal.trim() !== '') {
        ...
        console.error("JSON path:", "../../JSON/marmoset_gene_pair.json");
