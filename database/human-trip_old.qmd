...
human_gene_pairTrip = gene_pair_trip.iloc[:, :21]
...
def update_table():
    show(
        ...
        columnDefs=[
            ...
            {"targets": list(range(-1, -15, -1)), "visible": False} # Hide last 16 columns by default
        ],
