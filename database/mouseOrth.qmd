...
<div id="table-content-mouse" style="opacity: 0;">
...
$(document).ready(function() {
  ...
  {
    "data": "Mouse LR Pair",
    "title": "<span title=\"Ligand-receptor Pair\">Mouse LR Pair</span>"
  },
  {
    "data": "Ligand Symbols",
  ...
  {
    "data": "Ligand MGI ID",
    "title": "<span title=\"Mouse Genome Informatics ID (link to MGI)\">Ligand MGI ID</span>"
  },
  {
    "data": "Receptor MGI ID",
    "title": "<span title=\"Mouse Genome Informatics ID (link to MGI)\">Receptor MGI ID</span>"
  },
  {
    "data": "Perplexity",
        ...
        action: function(e, dt, node, config) {
            ...
            updateSelectionCounter(); // ADD THIS LINE
                ...
                setTimeout(function() {
                    ...
                    var input = $('<input type="text" placeholder="Search Ligand(s) / Receptor(s): i.e. ACE, CD24, EGFR, Epha3, 5430401F13Rik" />')
                        .css({
                            'width': '100%',
                            'padding': '8px',
                            'font-size': '1.1rem',
