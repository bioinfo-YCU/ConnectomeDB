...
<table id="mouse-table" class="display nowrap cell-border compact" style="width:100%">
    <thead></thead>
    <tfoot></tfoot>
</table>
...
$(document).ready(function() {
    ...
    $.getJSON("../JSON/mouse_gene_pair.json", function(data) {
  ...
  {
    "data": "Ligand",
    "title": "<span title=\"Double-click header of Ligand to ensure all values are shown\">Ligand&nbsp;</span>"
  },
  {
    "data": "Receptor",
    "title": "<span title=\"Double-click header of Receptor to ensure all values are shown\">Receptor&nbsp;</span>"
  },
  {
    "data": "Ligand MGI ID",
    "title": "<span title=\"Genome Informatics (MGI) ID. Click on the link for more details\">Ligand MGI ID</span>"
  },
  {
    "data": "Receptor MGI ID",
    "title": "<span title=\"Genome Informatics (MGI) ID. Click on the link for more details\">Receptor MGI ID</span>"
  },
  {
    "data": "Ligand Ensembl ID",
    "title": "Ligand Ensembl ID"
  },
  {
    "data": "Ligand GOC score",
    "title": "Ligand GOC score"
  },
  {
    "data": "Ligand WGA coverage",
    "title": "Ligand WGA coverage"
  },
  {
    "data": "Ligand % Identity",
    "title": "Ligand % Identity"
  },
  {
    "data": "Ligand Target % Identity",
    "title": "Ligand Target % Identity"
  },
  {
    "data": "Ligand Orthology Confidence",
    "title": "Ligand Orthology Confidence"
  },
  {
    "data": "Ligand Name",
    "title": "Ligand Name"
  },
  {
    ...
    "title": "Receptor Ensembl ID"
  },
  {
    "data": "Receptor GOC score",
    "title": "Receptor GOC score"
  },
  {
    "data": "Receptor WGA coverage",
    "title": "Receptor WGA coverage"
  },
  {
    "data": "Receptor % Identity",
    "title": "Receptor % Identity"
  },
  {
    "data": "Receptor Target % Identity",
    "title": "Receptor Target % Identity"
  },
  {
    "data": "Receptor Orthology Confidence",
    "title": "Receptor Orthology Confidence"
  },
  {
    "data": "Receptor Name",
    "title": "Receptor Name"
  ...
  {
    "data": "Human Ligand",
    "title": "<span title=\"Official Gene Symbol; Hover on symbols below to show gene names\"\">Human Ligand&nbsp;&nbsp;&nbsp;</span</span>"
  },
  {
    "data": "Human Receptor",
    "title": "<span title=\"Official Gene Symbol; Hover on symbols below to show gene names\"\">Human Receptor&nbsp;&nbsp;&nbsp;</span</span>"
  },
  {
    "data": "Human Ligand Symbols",
    "title": "<span title=\"Double-click header of Ligand Symbols to ensure all values are shown\"\">Human Ligand Symbols&nbsp;</span</span>"
  },
  {
    "data": "Human Receptor Symbols",
    "title": "<span title=\"Double-click header of Receptor Symbols to ensure all values are shown\"\">Human Receptor Symbols&nbsp;</span</span>"
  },
  {
  ...
  },
  {
    ...
    "title": "<span title=\"Double-click header of Interaction Type to ensure all values are shown\">Interaction Type&nbsp;</span>"
        ...
        headerHtml += '</tr>';
        $('#mouse-table thead').html(headerHtml);
        ...
        var table = $('#mouse-table').DataTable({
            data: data,
            columns: [
                {
                    data: null,
            ...
            buttons: [
                ...
                {
                    extend: 'csvHtml5',
                    filename: 'ConnectomeDB2025_mouse',
                    exportOptions: {
            ...
            initComplete: function () {
                ...
                setTimeout(function() {
                    ...
                    $('#mouse-table').closest('.dataTables_wrapper').prepend(filterContainer);

                    var filterDiv = $('<div style="max-width: 100%;"></div>');
                    var label = $('<label></label>');

                    // Create input without datalist (no autofill)
                    var input = $('<input type="text" placeholder="i.e. CD24, EGFR, A2M, Epha3, 5430401F13Rik, no human ortholog" />')
                        .css({
                            'width': '100%',
                            'padding': '8px',
                            'font-size': '1rem',
                        ...
                        .on('input keyup', function () {
                            ...
                            if (val === '') {
                                ...
                                if (searchTerms.length > 0) {
                                    // Update the search function to include columns 3, 4, 23, 24
                                    $.fn.dataTable.ext.search.push(function(settings, data, dataIndex) {
                                        ...
                                        var col24Value = data[24] ? data[24].toString().replace(/<[^>]*>/g, '').toLowerCase() : '';
                                        var col25Value = data[25] ? data[25].toString().replace(/<[^>]*>/g, '').toLowerCase() : '';
                                    
                                        return searchTerms.some(term =>
                                            col3Value.includes(term) || 
                                            col4Value.includes(term) || 
                                            col24Value.includes(term) || 
                                            col25Value.includes(term)
                                        );
                                    });
                ...
                api.on('order.dt search.dt', function () {
                    ...
                    if (searchVal && searchVal.trim() !== '') {
                        ...
                        api.rows().sort(function (rowIdxA, rowIdxB) {
                            ...
                            const valuesA = [normalize(rowDataA[3]), normalize(rowDataA[4]), normalize(rowDataA[24]), normalize(rowDataA[25])];
                            const valuesB = [normalize(rowDataB[3]), normalize(rowDataB[4]), normalize(rowDataB[24]), normalize(rowDataB[25])];
                        ...
                        // Reset to default sort when input is cleared
                        api.order([[1, 'asc']]);
                    }
                });
            }
        ...
        console.error("JSON path:", "../JSON/mouse_gene_pair.json");
