...
dataset_name = "rnorvegicus_gene_ensembl" # "drerio_gene_ensembl" for zebra fish, "rnorvegicus_gene_ensembl" for rat, "mmusculus_gene_ensembl" for mouse
gene_symbol_field = "rgd_symbol"  # "rgd_symbol" for rat, "external_gene_name" for mouse
