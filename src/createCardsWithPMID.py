...
### For the latest DB, skip for now
 ...
 # Apply the uniprot mapping to 'AmiGO'
    ...
    ligand_card_2['AI summary'] = ligand_card_2.apply(create_ligand_perplexity_link, axis=1)
    ...
    receptor_card_2['AI summary'] = receptor_card_2.apply(create_receptor_perplexity_link, axis=1)
