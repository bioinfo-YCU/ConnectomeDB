...
`createFunctionalAnnotTable.py`: Prepare datatables (cleaning and hyperlinking, adding tool tips, etc) input for the database qmds

***

**The following scripts should be reran in this particular order when there are new PMIDs:**
...
**The following scripts should be reran in this particular order when there are new information (disease, pathway, location), pairs, PMIDs:**
