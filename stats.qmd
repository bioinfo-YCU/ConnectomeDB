...
### Gene count based on the [**Ligand**](annotations/ligand_group.qmd) and [**Receptor**](annotations/receptor_group.qmd) Annotations
...
for col in cat_cols:
    ...
    fig_lig2.update_traces(textinfo='percent+label', textposition='inside')
